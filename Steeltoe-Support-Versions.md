...
| ---------------- | ------------       | ---------------- | --- | --------------------  |
| 3.2.x            | May 26, 2022       | May 26, 2026     | No  | .NET Core 3.1 (LTS), .NET 6 (LTS) |
...
| 3.0.x            | August 24, 2020    | August 31, 2023  | No  |
| 2.5.x            | October 15, 2020   | October 31, 2023 | Yes |
...
Breaking changes are generally only allowed in major releases and only when necessary for code optimization, architecture changes or to remove deprecated code.
